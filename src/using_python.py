...
NUMBER_OF_LINES = 1000_000_000

def process_temperatures(path_to_csv):
    ...
    with open(path_to_csv, 'r', encoding='utf-8') as file:
        ...
        # using tqdm directly on the iterator, this will show the completion percentage.
    ...
    results = {}
    for station, qty_measurements in measurements.items():
        mean_temp = sums[station] / qty_measurements
...
if __name__ == "__main__":
    path_to_csv = "data/measurements.txt"

    print("Starting file processing.")
    start_time = time.time()  # Start time

    results = process_temperatures(path_to_csv)
